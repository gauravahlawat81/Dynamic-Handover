              ...
              if (it->haveRsrpResult)
                {
                  if ((bestNeighbourRsrp < it->rsrpResult)
                    ...
                    {
                      std::cout<<"A3 RSRP Values "<<it->rsrpResult<<"\n";
                      std::cout<<"A3 RSRQ Values "<<it->rsrqResult<<"\n";
          ...
          if (bestNeighbourCellId > 0)
            {
              ...
              std::cout<<"target cell RSRP " << (uint16_t) bestNeighbourRsrp<<"\n";
              std::cout<<"serving cell RSRP " << (uint16_t) measResults.rsrpResult<<"\n";
